...
class _CircleCheckBoxState extends State<CircleCheckBox> with TickerProviderStateMixin {
...
class _RenderCheckbox extends RenderToggleable {
  ...
  void _drawBorder(Canvas canvas, RRect outer, double t, Paint paint) {
    ...
    final Rect rec = Rect.fromCircle(center: inner.center,radius: 12);
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (_oldValue == false || value == false) {
      ...
      if (t <= 0.5) {
        ...
        canvas.drawCircle(outer.center, 12, paint);
