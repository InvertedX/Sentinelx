...
class _CardWidgetState extends State<CardWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: <Widget>[
        Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(6), color: Theme
            .of(context)
            .primaryColor,), child: Column(mainAxisAlignment: MainAxisAlignment.end,
            children: [
              ClipPath(clipper: WaveClipper(reverse: true),
        ...
        Padding(padding: const EdgeInsets.all(8.0), child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            ...
            children: <Widget>[
              Expanded(flex: 2, child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: <Widget>[
                    Expanded(
                        child: Align(alignment: Alignment.bottomLeft, child: Chip(avatar: CircleAvatar(child: Center(
                          child: Icon(icon, size: 12,),),), label: Text(typeText),),), flex: 1),
                    Expanded(flex: 1, child: Text(xpubModel.label, overflow: TextOverflow.ellipsis,
              ...
              Expanded(flex: 3,
                  child: Container(alignment: Alignment.centerLeft,
                    child: Text("BTC ${satToBtc(xpubModel.final_balance)}", maxLines: 1,
                      ...
                      overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold),),)),
              Expanded(child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: <Widget>[
                  Expanded(child: Container(width: 80,
