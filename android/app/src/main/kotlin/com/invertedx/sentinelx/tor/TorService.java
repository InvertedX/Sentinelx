...
public class TorService extends Service {
    ...
    public static final String TOR_CHANNEL = "TOR";
    ...
    private NotificationCompat.Action getStopAction(String message) {
        ...
        return new NotificationCompat.Action(R.drawable.ic_launcher, message, actionIntent);
    }
    ...
    private NotificationCompat.Action getRenewAction() {
        ...
        return new NotificationCompat.Action(R.drawable.ic_launcher, "New identity", actionIntent);
    }
