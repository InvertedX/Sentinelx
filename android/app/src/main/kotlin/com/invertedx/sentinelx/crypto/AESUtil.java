package com.invertedx.sentinelx.crypto;
...
//    private static Logger mLogger = LoggerFactory.getLogger(AESUtil.class);
    ...
    public static String decrypt(String ciphertext, CharSequence password, int iterations)  {
    ...
    public static String encrypt(String cleartext, CharSequence password, int iterations)    {
